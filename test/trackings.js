...
if (create_tracking) {
	exports.CreateTracking = {
		...
		'Ok (no slug)': function(test) {
			test.expect(5);
			// usps
			packpin.createTracking(GLOBAL.tracking.usps, {}, function(err, result) {
				test.equal(err, null);
		...
		'Ok (w/ slug tnt)': function(test) {
			...
			// tnt
			packpin.createTracking(GLOBAL.tracking.tnt, {slug: 'tnt'}, function(err, result) {
				test.equal(err, null);
		...
		'Ok (w/ slug fedex)': function(test) {
			...
			// Fedex
			packpin.createTracking(GLOBAL.tracking.fedex, {slug: 'fedex'}, function(err, result) {
				test.equal(err, null);
		...
		'Ok (w/ slug ups)': function(test) {
			...
			// Fedex
			packpin.createTracking(GLOBAL.tracking.ups, {slug: 'ups'}, function(err, result) {
				test.equal(err, null);
		...
		'Ok (w/ slug toll-global-express)': function(test) {
			...
			// toll-global-express
			packpin.createTracking(GLOBAL.tracking['toll-global-express'], {slug: 'toll-global-express'}, function(err, result) {
				test.equal(err, null);
		...
		'Ok (w/ slug dhl)': function(test) {
			...
			// dhl
			packpin.createTracking(GLOBAL.tracking.dhl, {slug: 'dhl'}, function(err, result) {
				test.ok(!err);
		...
		'Error (w/ slug usps)': function(test) {
			...
			// usps
			packpin.createTracking(GLOBAL.tracking.usps, {slug: 'usps'}, function(err, result) {
		...
		'Ok (w/ slug dx)': function(test) {
			...
			// usps
			packpin.createTracking(GLOBAL.tracking.dx.tracking_number, {slug: 'dx', tracking_postal_code: GLOBAL.tracking.dx.tracking_postal_code}, function(err, result) {
...
if (get_tracking) {
	exports.Tracking = {
		'Ok ups': function(test) {
			...
			// UPS
			packpin.getTracking('ups', GLOBAL.tracking.ups, {}, function(err, result) {
		...
		'Ok ups limited fields': function(test) {
			...
			// UPS
			packpin.getTracking('ups', GLOBAL.tracking.ups, {fields: ['slug', 'tracking_number']}, function(err, result) {
		...
		'OK (DX)': function(test) {
			...
			packpin.getTracking('dx', GLOBAL.tracking.dx.tracking_number, { tracking_postal_code: GLOBAL.tracking.dx.tracking_postal_code }, function(err, result) {
...
if (get_trackings) {
	exports.Trackings = {
		...
		'OK': function(test) {
			...
			packpin.getTrackings({}, function(err, results) {
...
if (update_tracking) {
	exports.UpdateTracking = {
		'Ok': function(test) {
			...
			// UPS
			packpin.updateTracking('ups', GLOBAL.tracking.ups, {}, function(err, result) {
				test.equal(err, null);
				test.equal(typeof result, 'object');
				test.equal(result.tracking.slug, 'ups');
				test.equal(result.tracking.tracking_number, GLOBAL.tracking.ups);
		...
		'Ok (with change)': function(test) {
			...
			// UPS
			packpin.updateTracking('ups', GLOBAL.tracking.ups, {title: 'Foobar'}, function(err, result) {
				test.equal(err, null);
				test.equal(typeof result, 'object');
				test.equal(result.tracking.slug, 'ups');
				test.equal(result.tracking.tracking_number, GLOBAL.tracking.ups);
...
if (checkpoint) {
	exports.Checkpoint = {
		...
		'Ok with fields': function(test) {
			...
			// UPS
			packpin.getLastCheckpoint('ups', GLOBAL.tracking.ups, ['message'], function(err, result) {
				test.equal(err, null);
		...
		'Ok': function(test) {
			...
			// UPS
			packpin.getLastCheckpoint('ups', GLOBAL.tracking.ups, [], function(err, result) {
				test.equal(err, null);
				test.equal(typeof result.checkpoint, 'object');
				test.done();
			});
...
if (delete_tracking) {
	exports.DeleteTracking = {
		...
		'Tracking Number is not exist': function(test) {
			...
			// UPS
			packpin.deleteTracking('ups', '12345677654', function(err, result) {
		...
		'Ok Delete dhl': function(test) {
			...
			// dhl
			packpin.deleteTracking('dhl', GLOBAL.tracking.dhl, function(err, result) {
				test.equal(err, null);
		...
		'Ok Delete fedex': function(test) {
			...
			// fedex
			packpin.deleteTracking('fedex', GLOBAL.tracking.fedex, function(err, result) {
				test.equal(err, null);
				test.equal(typeof result.tracking, 'object');
				test.equal(result.tracking.slug, 'fedex');
				test.equal(result.tracking.tracking_number, GLOBAL.tracking.fedex);
		...
		'Ok Delete tnt': function(test) {
			...
			// tnt
			packpin.deleteTracking('tnt', GLOBAL.tracking.tnt, function(err, result) {
				test.equal(err, null);
				test.equal(typeof result.tracking, 'object');
				test.equal(result.tracking.slug, 'tnt');
				test.equal(result.tracking.tracking_number, GLOBAL.tracking.tnt);
		...
		'Ok Delete toll-global-express': function(test) {
			...
			// toll-global-express
			packpin.deleteTracking('toll-global-express', GLOBAL.tracking['toll-global-express'], function(err, result) {
				test.equal(err, null);
				test.equal(typeof result.tracking, 'object');
				test.equal(result.tracking.slug, 'toll-global-express');
				test.equal(result.tracking.tracking_number, GLOBAL.tracking['toll-global-express']);
		...
		'Ok Delete ups': function(test) {
			...
			// UPS
			packpin.deleteTracking('ups', GLOBAL.tracking.ups, function(err, result) {
				test.equal(err, null);
				test.equal(typeof result.tracking, 'object');
				test.equal(result.tracking.slug, 'ups');
				test.equal(result.tracking.tracking_number, GLOBAL.tracking.ups);
		...
		'Ok Delete usps': function(test) {
			...
			// usps
			packpin.deleteTracking('usps', GLOBAL.tracking.usps, function(err, result) {
				test.equal(err, null);
				test.equal(typeof result.tracking, 'object');
				test.equal(result.tracking.slug, 'usps');
				test.equal(result.tracking.tracking_number, GLOBAL.tracking.usps);
		...
		'Ok Delete dx': function(test) {
			...
			// usps
			packpin.deleteTracking('dx', GLOBAL.tracking.dx.tracking_number, {tracking_postal_code: GLOBAL.tracking.dx.tracking_postal_code}, function(err, result) {
